...
public class GameObjectPool : MonoBehaviour
{
    ...
    private void GameObjectPoolInit()
    {
    ...
    private GameObject InstantiateObject(GameObject prefabs ,ref List<GameObject> addList)
    {
        GameObject go = Instantiate(prefabs, transform);
        go.SetActive(false);
        addList.Add(go);
        return go;
    }
